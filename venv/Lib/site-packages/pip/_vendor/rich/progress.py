...
class ProgressColumn(ABC):
    ...
    def get_table_column(self) -> Column:
        """Get a table column, used to build notes table."""
...
class MofNCompleteColumn(ProgressColumn):
    ...
    Best for bounded notes with int quantities.
...
class Progress(JupyterMixin):
    ...
    Args:
        ...
        expand (bool, optional): Expand notes table to fit width. Defaults to False.
    """
    ...
    @property
    def finished(self) -> bool:
        """Check if all notes have been completed."""
        with self._lock:
            if not self._tasks:
                return True
